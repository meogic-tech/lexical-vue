...
import { $createParagraphNode, $getRoot, $getSelection as $getSelection5, createEditor } from "lexical";
      ...
      if (initialEditorState === void 0) {
        editor2.update(() => {
          ...
          if (root.isEmpty()) {
            ...
            if ($getSelection5() !== null || activeElement !== null && activeElement === editor2.getRootElement())
              paragraph.select();
          }
...
import { computed as computed4, onUnmounted as onUnmounted3, ref as ref9, watchEffect as watchEffect2 } from "vue";
...
import { computed as computed5, ref as ref10 } from "vue";
...
var LexicalCharacterLimitPlugin_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ _defineComponent16({
  ...
  setup(__props) {
    ...
    const remainingCharacters = ref10(0);
...
import {
  ...
  mergeRegister as mergeRegister9
} from "@lexical/utils";
import {
...
var LexicalBlockWithAlignableContents_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ _defineComponent19({
  ...
  setup(__props) {
    ...
    function onDelete(event) {
      if (isSelected.value && $isNodeSelection2($getSelection9())) {
        event.preventDefault();
        editor.update(() => {
...
import { $findMatchingParent, mergeRegister as mergeRegister10 } from "@lexical/utils";
